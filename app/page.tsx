      ...
      <main className="flex-grow">
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8 items-center">
            ...
            <div className="space-y-6 lg:col-span-7">
              ...
              <p className="max-w-xl text-lg leading-relaxed text-zinc-400">
                Accomplished mobile application developer specializing in building high-performance 
                <strong className="text-zinc-200"> React Native</strong>, <strong className="text-zinc-200">iOS</strong>, and 
                <strong className="text-zinc-200"> Android</strong> apps. Experienced team lead focusing on modern architecture, CI/CD automation, and fast-loading split bundle loading.
              </p>
            ...
            <div className="lg:col-span-5 relative">
              ...
              <div className="glow-card relative rounded-2xl border border-zinc-800/80 bg-zinc-900/90 shadow-2xl overflow-hidden font-mono text-xs">
                ...
                <div className="p-6 space-y-4 text-zinc-300 overflow-x-auto">
                  ...
                  <div className="pl-4">
                    <span className="text-zinc-500">role:</span> <span className="text-emerald-300">"Team Lead & Sr. Mobile Engineer"</span>,
                  </div>
                  <div className="pl-4">
                    <span className="text-zinc-500">experienceYears:</span> <span className="text-amber-300">7.2</span>,
                  </div>
                  <div className="pl-4">
        ...
        <section className="mx-auto max-w-6xl px-6 py-12 relative z-10 border-t border-zinc-900">
          <ScrollReveal>
            <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
              {[
                { number: "7+", label: "Years Experience", icon: Briefcase, color: "text-indigo-400" },
          ...
          <ScrollReveal className="space-y-12">
            <div className="space-y-4 text-center">
              ...
              <p className="mx-auto max-w-xl text-zinc-400 text-sm sm:text-base">
                An overview of my engineering competencies, languages, and technical frameworks honed over 7+ years.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  skills: ["Jenkins Automation", "Fastlane Build Scripts", "Firebase App Distribution"],
                },
                {
                  title: "Monitoring & Observability",
                  icon: Activity,
                  color: "from-rose-500/10 to-rose-600/5 border-rose-500/20 hover:border-rose-500/40 text-rose-400",
                  skills: ["Sentry Tracking", "Crashlytics Logs", "Bugsnag Alerts", "Google Analytics"],
                },
                {
                  title: "Methodologies",
                  icon: Cpu,
                  color: "from-sky-500/10 to-sky-600/5 border-sky-500/20 hover:border-sky-500/40 text-sky-400",
                  skills: ["Agile Development", "Scrum Framework", "Sprint Planning & Retrospectives"],
                },
              ].map((group, idx) => (
                <div
                  key={idx}
        ...
        <section id="timeline" className="mx-auto max-w-6xl px-6 py-20 relative z-10 border-t border-zinc-900">
          <ScrollReveal className="space-y-16">
            ...
            <div className="relative border-l-2 border-zinc-800/80 pl-8 ml-4 md:ml-8 space-y-12">
              
              {/* Item 1: Juniper Square */}
              <div className="relative">
                {/* Bullet */}
                <div className="absolute -left-[41px] top-0.5 flex h-6 w-6 items-center justify-center rounded-full border-2 border-indigo-500 bg-zinc-950 text-indigo-400 shadow-md">
                ...
                <div className="space-y-3">
                  ...
                  <ul className="space-y-3 text-sm text-zinc-400">
                    <li className="flex items-start gap-2.5">
                      ...
                      <span>Worked on major projects introducing critical pillars to the application, specifically the <strong className="text-zinc-200">Prospects, Offering, and Entity</strong> modules.</span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="text-base shrink-0 select-none">⚡</span>
                      <span>Resolved pre-existing complex <strong className="text-zinc-200">production bugs</strong> and integrated high-performance interactive <strong className="text-zinc-200">UI animations</strong>.</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="relative">
                {/* Bullet */}
                <div className="absolute -left-[41px] top-0.5 flex h-6 w-6 items-center justify-center rounded-full border-2 border-sky-400 bg-zinc-950 text-sky-400 shadow-md">
                  <Briefcase className="h-3 w-3" />
                </div>
                <div className="space-y-3">
                  <div className="flex flex-wrap items-center justify-between gap-2">
                  ...
                  <ul className="space-y-3 text-sm text-zinc-400">
                    <li className="flex items-start gap-2.5">
                      <span className="text-base shrink-0 select-none">📱</span>
                      <span>Resolved navigation-related flows and modal constraints throughout the Washmen user-facing application, significantly improving <strong className="text-zinc-200">UI accessibility and navigation reliability</strong>.</span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="text-base shrink-0 select-none">✨</span>
                      <span>Collaborated on revamping the new application UI, successfully releasing the update on schedule with <strong className="text-zinc-200">zero production bugs</strong>.</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="relative">
                {/* Bullet */}
                <div className="absolute -left-[41px] top-0.5 flex h-6 w-6 items-center justify-center rounded-full border-2 border-emerald-500 bg-zinc-950 text-emerald-400 shadow-md">
                  <Briefcase className="h-3 w-3" />
                </div>
                <div className="space-y-3">
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    ...
                    <span className="text-xs text-zinc-500 flex items-center gap-1">
                      <MapPin className="h-3 w-3" /> Gurugram, Haryana, India
                    </span>
                  </div>
                  <div>
                  ...
                  <ul className="space-y-3 text-sm text-zinc-400">
                    <li className="flex items-start gap-2.5">
                      <span className="text-base shrink-0 select-none">🚀</span>
                      <span>Modernised Housing App by migrating to <strong className="text-zinc-200">React Native New Architecture (0.79.5)</strong>, building custom <strong className="text-zinc-200">TurboModules</strong> and <strong className="text-zinc-200">Fabric components</strong> for improved performance.</span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="text-base shrink-0 select-none">📦</span>
                      <span>Implemented <strong className="text-zinc-200">split bundle loading</strong> for cross-platform optimisation, transitioning to synchronous communication patterns and achieving <strong className="text-zinc-200">25% improvement in thread performance</strong>.</span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="text-base shrink-0 select-none">👥</span>
                      <span>Enhanced team productivity through systematic technical issue identification and rapid resolution, achieving <strong className="text-zinc-200">99% on-time delivery rate</strong> for product features.</span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="text-base shrink-0 select-none">⚙️</span>
                      <span>Set up and maintained Android and iOS CI/CD pipelines on <strong className="text-zinc-200">Jenkins</strong>, achieving a <strong className="text-zinc-200">99% build creation success rate</strong>.</span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="text-base shrink-0 select-none">🧹</span>
                      <span>Designed an automated Jenkins cleanup pipeline to resolve storage constraints and maintain <strong className="text-zinc-200">uninterrupted CI/CD operations</strong>.</span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="text-base shrink-0 select-none">🔥</span>
                      <span>Automated build creation and uploads to Firebase App Distribution, reducing build delivery time to QA by <strong className="text-zinc-200">80%</strong> and increasing QA efficiency.</span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="text-base shrink-0 select-none">📷</span>
                      <span>Worked on integrating Ricoh and GoPro <strong className="text-zinc-200">360-degree camera devices</strong> to capture and create digital property tours.</span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="text-base shrink-0 select-none">🔌</span>
                      <span>Integrated Seller Pod's React Native code with native Android and iOS code, ensuring a <strong className="text-zinc-200">seamless hybrid navigation experience</strong> across different sections.</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="relative">
                {/* Bullet */}
                <div className="absolute -left-[41px] top-0.5 flex h-6 w-6 items-center justify-center rounded-full border-2 border-violet-500 bg-zinc-950 text-violet-400 shadow-md">
                  <Briefcase className="h-3 w-3" />
                </div>
                <div className="space-y-3">
                  <div className="flex flex-wrap items-center justify-between gap-2">
                  ...
                  <ul className="space-y-3 text-sm text-zinc-400">
                    <li className="flex items-start gap-2.5">
                      <span className="text-base shrink-0 select-none">⬆️</span>
                      <span>Upgraded the React Native version from <strong className="text-zinc-200">0.63.4 to 0.69.4</strong> for the Housing app and updated outdated libraries that were blocking the upgrade.</span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="text-base shrink-0 select-none">⚙️</span>
                      <span>Created generic components to reduce code duplication and <strong className="text-zinc-200">decrease render time by 20%</strong>.</span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="text-base shrink-0 select-none">🖥️</span>
                      <span>Created <strong className="text-zinc-200">server-driven UI</strong> to minimise the risk of affecting 100% of users in the app.</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="space-y-3">
                  ...
                  <ul className="space-y-3 text-sm text-zinc-400">
                    <li className="flex items-start gap-2.5">
                      <span className="text-base shrink-0 select-none">🤝</span>
                      <span>Coordinated with clients to understand feature requirements and plan them in the sprint.</span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="text-base shrink-0 select-none">🎯</span>
                      <span>As an individual contributor, consistently ensuring <strong className="text-zinc-200">100% on-time delivery</strong> of the features.</span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="text-base shrink-0 select-none">📤</span>
                      <span>Crafted an <strong className="text-zinc-200">iOS share image extension</strong> that simplifies post creation from the gallery, outside the app, enhancing user convenience and leading to a <strong className="text-zinc-200">30% increase in overall post creation</strong>.</span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="text-base shrink-0 select-none">🤖</span>
                      <span>Developed and delivered a proof-of-concept Distributed Delivery app from scratch using React Native to demonstrate the applicability of <strong className="text-zinc-200">Fetch.ai technology</strong>, achieving a 100% success rate.</span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="text-base shrink-0 select-none">👥</span>
                      <span>Collaborated within a 10+ member Agile team, actively contributing to sprint planning, retrospective meetings, and continuous improvements.</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="relative">
                {/* Bullet */}
                <div className="absolute -left-[41px] top-0.5 flex h-6 w-6 items-center justify-center rounded-full border-2 border-amber-500 bg-zinc-950 text-amber-400 shadow-md">
                  <Briefcase className="h-3 w-3" />
                </div>
                <div className="space-y-3">
                  <div className="flex flex-wrap items-center justify-between gap-2">
                  ...
                  <ul className="space-y-3 text-sm text-zinc-400">
                    <li className="flex items-start gap-2.5">
                      <span className="text-base shrink-0 select-none">📱</span>
                      <span>Collaborated on the <strong className="text-zinc-200">ActivityHero iOS app</strong> with a team of two, successfully launching the app on schedule with all web features included, resulting in client appreciation.</span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="text-base shrink-0 select-none">🔔</span>
                      <span>Integrated <strong className="text-zinc-200">Crashlytics</strong> for app monitoring and implemented <strong className="text-zinc-200">push notifications</strong> to increase app opens and engagement.</span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="text-base shrink-0 select-none">⚡</span>
                      <span>Engineered the <strong className="text-zinc-200">HydroOttawa utility app</strong> using React Native from inception to deployment on the Play Store, incorporating server-driven features.</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {[
                ...
                },
                {
                  id: "housing",
                  title: "Housing App",
                  desc: "Architected seamless React Native to native code integration across Android and iOS platforms, improving app performance by 20% while managing 100% of Seller Pod's cross-platform responsibilities.",
                ...
                },
                {
                  ...
                  desc: "Developed a comic reader platform from scratch in React Native. Supports tiny devices, in-app purchases, offline reading via local caching, and deep-link integrations.",
                ...
                },
                {
                  ...
                  desc: "Developed a social advocacy app enabling companies to leverage employees for social media marketing activities, allowing employees to earn and cash in points.",
                ...
                },
                {
                  ...
                  desc: "Developed a cloud-based video editor with features for creating/editing videos, custom animations, themes, music, voice-overs, and various customisations. Integrated Squall library for Adobe AE motion titles and added extensive, intuitive animations for user actions.",
              ...
              <div className="max-w-2xl w-full space-y-6">
                <div className="rounded-2xl border border-zinc-800 bg-zinc-900/30 p-8 space-y-6">
                  ...
                  <p className="text-sm text-zinc-400 leading-relaxed">
                    Feel free to reach out directly via mail, phone, or LinkedIn. I am always happy to discuss new opportunities or exchange notes on mobile technology.
                  </p>
                  ...
                  <div className="pt-4 border-t border-zinc-850 flex items-center gap-4 justify-center sm:justify-start">
                    <a
                      href="https://linkedin.com/in/rahulsolanki1818"
                      target="_blank"
                      rel="noopener noreferrer"
